		...
		<div id="nav">
			...
			<div id="nav-top">
				<div class="container">
					...
					<!-- logo -->
					<div class="nav-logo">
						<a href="index.php" class="logo" style="text-transform: uppercase">Diagnostics</a>
					</div>
					<!-- /logo -->
							...
							<ul>
								<li>
									<a href="#" class="social-facebook">
										...
										<span>306.3K<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-twitter">
										<i class="fa fa-twitter"></i>
										<span>109.3<br>Followers</span>
									</a>
								</li>
								<li>
									<a href="#" class="social-google-plus">
										<i class="fa fa-google-plus"></i>
										<span>81.2<br>Followers</span>
									</a>
								</li>
							</ul>
						</div>
